...
export async function generateMetadata({
  ...
  return generateSEO({
    ...
    path: `/${lang}/html-entity-encoder/`,
    lang: lang as Locale,
    keywords: toolT.keywords as string[],
  });
}

export default async function HtmlEntityEncoderPage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
  ...
  return (
    <ToolPageLayout lang={lang as Locale} toolSlug="html-entity-encoder" t={t}>
      <HtmlEntityEncoder t={t} />
    </ToolPageLayout>
  );
}
