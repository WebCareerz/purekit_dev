...
export async function generateMetadata({
  ...
  return generateSEO({
    ...
    path: `/${lang}/javascript-beautifier/`,
    lang: lang as Locale,
    keywords: toolT.keywords as string[],
  });
}

export default async function JavaScriptBeautifierPage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
  ...
  return (
    <ToolPageLayout lang={lang as Locale} toolSlug="javascript-beautifier" t={t}>
      <JavaScriptBeautifier t={t} />
    </ToolPageLayout>
  );
}
